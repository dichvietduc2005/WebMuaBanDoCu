...
<head>
    ...
    <link href="<?php echo BASE_URL; ?>public/assets/css/footer.css" rel="stylesheet">
...
<body>
    ...
    <!-- Review Modal Section - Placed at the top of body to avoid stacking context issues -->
    <div class="modal fade" id="reviewModal" tabindex="-1" aria-hidden="true" style="z-index: 100000 !important;">
        <div class="modal-dialog modal-dialog-centered modal-lg" style="z-index: 100001 !important;">
            <div class="modal-content modal-review-content">
                ...
                <div class="modal-body modal-review-body">
                    ...
                    <div class="review-product-info">
                        ...
                        <?php else: ?>
                            <div
                                class="review-product-img d-inline-flex align-items-center justify-content-center bg-light">
                    ...
                    <div class="review-textarea-wrapper">
                        <textarea class="review-textarea" id="contentReview"
                    ...
                    <div class="product-images">
                        <?php if (!empty($product_images)): ?>
                            <div class="main-image-wrapper" id="mainImageWrapper">
                                <img src="<?php echo BASE_URL . 'public/' . htmlspecialchars($product_images[0]['image_path']); ?>"
                                    alt="<?php echo htmlspecialchars($product['title']); ?>" class="main-image"
                                    id="mainImage">
                                ...
                                <?php if (count($product_images) > 1): ?>
                                    <div class="image-pagination">
                                        <span id="currentImageIndex">1</span> / <span
                                            id="totalImages"><?php echo count($product_images); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="product-info">
                            ...
                            <div class="price-section">
                                <div class="d-flex flex-column gap-1">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <span class="original-price"
                                            style="font-size: 18px; color: #999; text-decoration: line-through;">
                                            <?php echo formatPrice($product['price'] * 1.25); ?>
                                        </span>
                                        <span class="discount-badge"
                                            style="background: #ee4d2d; color: white; padding: 2px 6px; border-radius: 4px; font-size: 12px; font-weight: 700;">
                                            -20%
                                        </span>
                                    </div>
                                ...
                                <button class="wishlist-btn" id="wishlistBtn"
                                    onclick="toggleWishlist(<?php echo $product['id']; ?>)" title="Yêu thích">
                            ...
                            <div class="shopee-guarantee">
                                ...
                                <span><strong>Bảo hành:</strong> Trả hàng miễn phí trong 15 ngày - 100% chính
                                    hãng</span>
                            </div>
                    ...
                    <div class="store-info-section" style="display: none;">
                        <div class="store-header">
                            <div class="store-header-row">
                                ...
                                <div class="store-details">
                                    <div class="store-name">
                                        <?php echo htmlspecialchars($product['seller_name'] ?? 'Người bán'); ?>
                                    </div>
                                    ...
                                    <div class="store-stats">
                                        <div class="store-stat-item">
                                            <span
                                                class="store-stat-value"><?php echo $product['seller_products_count'] ?? 0; ?></span>
                                            <span>Sản phẩm</span>
                                        </div>
                                        <div class="store-stat-item">
                            ...
                            <button class="view-shop-btn"
                                onclick="window.location.href='<?php echo BASE_URL; ?>app/View/product/shop.php?seller=<?php echo $product['user_id']; ?>'">
                                Xem Shop
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="description-layout">
                        ...
                        <div class="description-text">
                            ...
                            <ul class="list-unstyled mt-3">
                                <li class="mb-2"><i class="fas fa-shield-alt text-success me-2"></i> Cam kết hàng chính
                                    hãng, đúng mô tả.</li>
                                <li class="mb-2"><i class="fas fa-truck text-success me-2"></i> Giao hàng siêu tốc trong nội
                                    thành.</li>
                                <li class="mb-2"><i class="fas fa-undo text-success me-2"></i> Đổi trả dễ dàng trong vòng 7
                                    ngày.</li>
                            </ul>
                        </div>
                            ...
                            <div class="specs-table-wrapper">
                                ...
                                <table class="specs-table">
                                    <tr>
                                        ...
                                        <td class="specs-value"><?php echo htmlspecialchars($product['category_name']); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="specs-value">
                                            <?php echo htmlspecialchars($product['location'] ?? 'Toàn quốc'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="specs-value">
                                            <?php echo htmlspecialchars($product['seller_name'] ?? 'Ẩn danh'); ?>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <div class="reviews-container" id="reviewsContainer">
                ...
                <?php if ($total_reviews > 0): ?>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-5 text-center border-end">
                                <div class="d-flex justify-content-center align-items-end mb-2">
                                    <span class="display-3 fw-bold text-warning me-2"
                                        style="line-height:1;"><?php echo $avg_rating; ?></span>
                            ...
                            <div class="col-md-7 ps-md-4">
                                <?php for ($star = 5; $star >= 1; $star--):
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="me-2 small fw-bold text-dark"
                                            style="width:10px;"><?php echo $star; ?></span>
                                        ...
                                        <div class="progress flex-grow-1" style="height: 6px; background-color: #f1f1f1;">
                                            ...
                                            <div class="progress-bar" role="progressbar"
                                                style="width: <?php echo $percent; ?>%; background-color: #2f80ed;"></div>
                                        </div>
                                        <span class="ms-3 small text-muted text-end"
                                            style="width: 35px;"><?php echo $percent > 0 ? round($percent) . '%' : '0%'; ?></span>
                                    </div>
                                <?php endfor; ?>
                            </div>
                        </div>
                    ...
                    <div class="text-center mb-4">
                        <button class="btn btn-write-review btn-lg w-100 p-3" data-bs-toggle="modal"
                            data-bs-target="#reviewModal" style="max-width: 400px; border-radius: 8px;">
                            Viết đánh giá
                        </button>
                    </div>
                <?php endif; ?>
                ...
                <?php if (isset($_SESSION['user_id'])):
                    ...
                    <!-- Review Modal moved to footer area -->
                    ...
                    <div class="related-grid">
                        <?php foreach ($related_products as $related): ?>
                            <div class="related-item"
                                onclick="window.location.href='?page=product_detail&id=<?php echo $related['id']; ?>'">
                                ...
                                <div class="related-content">
                                    ...
                                    <div class="text-muted small">Tình trạng:
                                        <?php echo getConditionText($related['condition_status']); ?>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
