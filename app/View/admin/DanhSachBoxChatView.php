...
?>
  ...
  <div class="grid grid-cols-1 gap-4 lg:grid-cols-[260px_minmax(0,1fr)] -mx-4 md:-mx-6 px-4 md:px-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03] flex-shrink-0">
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div class="relative flex-shrink-0">
                  <div class="w-11 h-11 rounded-full bg-gray-600 flex items-center justify-center text-white font-semibold text-sm">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-center justify-between mb-1">
                    ...
                    <?php if ((int)($chat_item['is_read'] ?? 0) === 0): ?>
                      <span class="flex items-center justify-center min-w-[18px] h-5 px-1.5 text-[10px] font-semibold text-white bg-blue-600 rounded-full">
                        1
                      </span>
                    <?php endif; ?>
                  </div>
    ...
    <div class="w-full min-w-0">
      <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03] h-[650px] flex flex-col w-full">
        <!-- Header chat -->
        ...
        <!-- Khung tin nhắn -->
        <div class="flex-1 overflow-y-auto p-5 bg-gray-50 dark:bg-gray-900/40" id="chatBox" style="scroll-behavior: smooth;">
