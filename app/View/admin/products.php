    ...
    <div class="sm:flex sm:items-center sm:justify-between mb-8">
        ...
        <div class="mt-4 sm:mt-0">
            <?php if (count($pending_products) > 0): ?>
                <span
                    class="inline-flex items-center justify-center px-3 py-1 text-xs font-bold leading-none text-indigo-100 bg-indigo-600 rounded-full">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        <?php foreach ($pending_products as $product): ?>
                            ...
                            <tr
                                class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors <?= $isFeatured ? 'bg-yellow-50 dark:bg-yellow-900/10' : '' ?>">
                                    ...
                                    <div class="relative h-16 w-16 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 group cursor-pointer"
                                        ...
                                        <?php if (!empty($product['image_path'])): ?>
                                            ...
                                            <div
                                                ...
                                                <svg class="w-6 h-6 text-white opacity-0 group-hover:opacity-100" fill="none"
                                ...
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-right text-sm font-bold text-indigo-600 dark:text-indigo-400">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center gap-2">
                                        <button onclick="openProductDetailModal(<?= (int) $product['id'] ?>)"
                                            class="inline-flex items-center gap-1.5 px-3 py-2 text-[11px] font-bold text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 transition-all shadow-sm shadow-indigo-100"
...
<div id="productDetailModal" class="relative z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <!-- Background backdrop -->
    <div class="fixed inset-0 bg-gray-900/75 bg-opacity-75 transition-opacity backdrop-blur-sm"
        onclick="closeProductDetailModal()"></div>

    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <!-- Modal panel -->
            <div
                class="relative transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl border border-gray-200 dark:border-gray-700">

                <!-- Header -->
                <div
                    class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    <h3 class="text-lg font-semibold leading-6 text-gray-900 dark:text-white flex items-center"
                        id="modal-title">
...
<script src="<?= BASE_URL ?>public/assets/js/admin_Product.js?v=<?= time() ?>"></script>
