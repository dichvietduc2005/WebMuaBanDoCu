            ...
            <div class="header-top-container">
                ...
                <div class="header-top-right">
                    <div class="header-actions">
                            <?php if ($is_logged_in): ?>
                            <!-- Notifications -->
                            <a href="<?php echo BASE_URL; ?>app/View/extra/notifications.php" class="header-icon-btn"
                                title="Thông báo">
                            ...
                            <!-- Cart -->
                            <a href="<?php echo BASE_URL; ?>app/View/cart/index.php" class="header-icon-btn" title="Giỏ hàng">
                            ...
                            <div class="dropdown d-none d-lg-block">
                               ...
                               <?php if ($_SESSION['user_role'] == 'admin'): ?>
                                        <li><a class="dropdown-item"
                                                href="<?php echo BASE_URL; ?>app/View/admin/QuanLyTaiKhoanView.php">
                                                <i class="fas fa-solid fa-medal me-2"></i>Quản lý tài khoản</a></li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo BASE_URL; ?>app/View/admin/DanhSachBoxChatView.php">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="<?php echo BASE_URL; ?>app/View/admin/manage_products.php">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>app/View/user/vouchers.php">
                                            <i class="fas fa-ticket-alt me-2"></i>Kho Voucher</a></li>
                                    <li><a class="dropdown-item"
                                            href="<?php echo BASE_URL; ?>app/View/user/ProfileUserView.php">
            ...
            <div class="header-search-container">
                <div class="header-search">
                    <form class="header-search-form" method="GET"
                        action="<?php echo BASE_URL; ?>app/View/extra/search_advanced.php" id="headerSearchFormElement">
                        <input type="text" class="header-search-input" name="q" placeholder="Tìm sản phẩm..."
                ...
                <div class="header-menu-sidebar" onclick="event.stopPropagation()">
                    <div class="header-menu-content">
                        ...
                        <ul class="header-menu-list">
                                ...
                                <li class="header-menu-item">
                                    <a href="<?php echo BASE_URL; ?>app/View/admin/DanhSachBoxChatView.php"
                            ...
                            <li class="header-menu-item">
                                <a href="<?php echo BASE_URL; ?>app/View/user/vouchers.php" class="header-menu-link">
