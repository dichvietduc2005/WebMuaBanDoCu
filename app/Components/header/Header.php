                ...
                <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-2 gap-lg-3 ms-lg-auto">
                    ...
                    <?php else: ?>
                        ...
                        <div class="d-flex flex-column flex-lg-row gap-2 w-100">
                            <a href="user/login.php" class="btn btn-outline-primary flex-grow-1 text-center">
                                <i class="fas fa-sign-in-alt me-2"></i>Đăng nhập
                            </a>
                            <a href="user/register.php" class="btn btn-primary flex-grow-1 text-center">
                                <i class="fas fa-user-plus me-2"></i>Đăng ký
                            </a>
                            <a href="product/sell.php" class="btn btn-warning fw-bold flex-grow-1 text-center">
