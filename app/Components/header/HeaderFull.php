    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top d-none d-lg-block" id="mainHeader"
        ...
        <div class="container-fluid px-2 px-sm-3 px-lg-4" style="padding-top: 4px; padding-bottom: 4px;">
            ...
            <a class="navbar-brand d-flex align-items-center me-auto me-lg-4 text-decoration-none"
                href="<?php echo BASE_URL; ?>public/index.php?page=home" style="transition: none; opacity: 1; padding: 0;">
                ...
                <h1 class="mb-0 fw-bold text-gradient d-sm-none"
                    style="font-size: clamp(14px, 3vw, 18px); color: #2563eb; line-height: 1.2;">
                    HIHand</h1>
            </a>
            ...
            <div class="d-flex flex-row align-items-center w-100 gap-2" style="justify-content: space-between;">
                ...
                <div style="display: flex; gap: 12px; align-items: center;">
                    <!-- Categories Button -->
                    <div class="dropdown">
                        <button class="btn d-flex align-items-center categories-btn" type="button" data-bs-toggle="dropdown"
                            aria-expanded="false"
                        ...
                        <ul class="dropdown-menu categories-dropdown-menu"
                            ...
                            <li
                                style="padding: 12px 16px; border-bottom: 1px solid #f0f0f0; background: white; border-radius: 12px 12px 0 0;">
                                            ...
                                            <a href="<?php echo BASE_URL; ?>app/View/product/category.php?slug=<?php echo htmlspecialchars($category['slug'] ?? ''); ?>"
                                                ...
                                                <div style="display: flex; align-items: center; gap: 12px;">
                                                    <i class="<?php echo $icon; ?>"
                                                        style="width: 20px; text-align: center; opacity: 0.8;"></i>
                ...
                <div class="desktop-search-section">
                    <form id="search-form2" class="desktop-search-form" method="GET"
                        action="<?php echo BASE_URL; ?>app/View/extra/search_advanced.php"
                        onsubmit="return validateSearchForm(event);">
                        <input type="text" id="search-input-desktop" name="q" placeholder="Bạn tìm gì hôm nay?"
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end account-dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>app/View/user/vouchers.php"><i
                ...
                <?php else: ?>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end guest-dropdown-menu">
                            <li>
                                <a href="<?php echo BASE_URL; ?>public/index.php?page=login" class="btn btn-primary mb-2">Đăng
                                    nhập</a>
                            </li>
                            <li>
                                <a href="<?php echo BASE_URL; ?>public/index.php?page=register"
                                    class="btn btn-outline-primary">Đăng kỷ tài khoản</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
