            ...
            <div class="d-flex align-items-center w-100">
                ...
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="category.php?slug=<?php echo $category['slug']; ?>"><?php echo htmlspecialchars($category['name']); ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                </div>                <!-- Search Form - Expanded -->
                <form id="search-form" class="flex-grow-1 me-4" method="GET" action="search.php" style="max-width: 500px;">
                ...
                <div class="d-flex align-items-center gap-3">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="My_products.php"><i class="fas fa-box me-2"></i>Tin đăng của tôi</a></li>
                                <li><a class="dropdown-item" href="user/order_history.php"><i class="fas fa-history me-2"></i>Lịch sử mua hàng</a></li>
                        ...
                        <!-- Post Ad Button -->
                        <a href="sell.php" class="btn btn-warning fw-bold px-4 py-2">
                    ...
                    <?php else: ?>
                        ...
                        <a href="sell.php" class="btn btn-warning fw-bold px-4">
                            <i class="fas fa-plus me-2"></i>ĐĂNG TIN
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <div class="container">
        <section class="section" id="featured-products">
            ...
            <div class="products-grid">
                ...
                <?php else: ?>                    <?php foreach ($featured_products as $product): ?>
                    <div class="product-card" style="cursor: pointer;" onclick="window.location.href='product_detail.php?id=<?php echo $product['id']; ?>'">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        <li><a href="TrangChu.php"><i class="fas fa-chevron-right"></i> Trang chủ</a></li>
                        ...
                        <li><a href="sell.php"><i class="fas fa-chevron-right"></i> Đăng bán</a></li>
