...
require_once(__DIR__ . '/../../config/config.php'); // General configuration, DB connection ($pdo)
require_once(__DIR__ . '/../../modules/order/functions.php'); // For order functions
...
<head>
    ...
    <link href="../../assets/css/checkout.css" rel="stylesheet"> <!-- You might want a specific success page CSS -->
    <style>
